 ...
 */
public class JNumberFormatField2 extends JTextField {
    ...
    private int limit = -1;
    public JNumberFormatField2(int casasDecimais) {
        this(new DecimalFormat((casasDecimais == 0 ? "#,##0" : "#,##0.") + makeZeros(casasDecimais)));
    }
    public JNumberFormatField2() {
        this(MONETARY_FORMAT);
    }
    public JNumberFormatField2(NumberFormat format) {// define o formato do
        // número
        ...
        setDocument(new PlainDocument() {
            ...
            public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
                String text = new StringBuilder(JNumberFormatField2.this.getText().replaceAll("[^0-9]", "")).append(str.replaceAll("[^0-9]", "")).toString();
    ...
    public static void main(String[] args) {
        ...
        frame.add(new JNumberFormatField2(new DecimalFormat("0.000")) {
            /**
			 * 
			 */
			private static final long serialVersionUID = -4006619173783434070L;
